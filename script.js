...
const translate=document.querySelector(".traducir")
const fromText=document.querySelector(".fromText")
const toText=document.querySelector(".toText")
const change= document.getElementById("change")
const reades= document.querySelectorAll(".read")
const listen = document.querySelector(".listen")
const languaje1="it-IT"
const languaje2="es-ES"
...
selectFirst.value=languaje1
selectSecond.value=languaje2

change.addEventListener("click",async_=>{
